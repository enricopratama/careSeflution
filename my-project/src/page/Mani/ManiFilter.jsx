...
const productOptions = [
  { name: "Gel Polish", inStock: true },
  { name: "Gel Extension", inStock: true },
  { name: "Basic Manicure", inStock: true },
  { name: "Acrylics", inStock: true },
]

// step 2 options radio button
const categoryOptions = [
  { name: "Almond", inStock: true },
  { name: "Square", inStock: true },
  { name: "Basic", inStock: true },
  { name: "Stiletto", inStock: true },
  { name: "Ballerina", inStock: true },
]
...
const Step2 = ({ cat, setCat }) => {
  return (
    <div className="col-span-2 md:px-16 md:py-4 p-12 bg-white w-full h-full">
      ...
      <div className="text-2xl text-black font-bold mb-6">
        Select the option that apply to your hair type
      </div>
      <div className="">
